...
const conversationData: ConversationLine[] = [
  { 
    ...
    audioUrl: '/audio-cache/А_21m00Tcm4TlvDq8ikWAM_0JTQvtCx0YDRi9C5.mp3'
  },
  { 
    id: 1, 
    speaker: 'Б', 
    text: 'Меня зовут Марк.',
    audioUrl: '/audio-cache/Б_VR6AewLTigWG4xSOukaG_0JzQtdC90Y8g0LfQ.mp3'
  },
  { 
    id: 2, 
    speaker: 'А', 
    text: 'Очень приятно.',
    audioUrl: '/audio-cache/А_21m00Tcm4TlvDq8ikWAM_0JQvtC60LAh.mp3'
  },
  { 
    id: 3, 
    speaker: 'А', 
    text: 'Ты студент какого факультета?',
    audioUrl: '/audio-cache/А_21m00Tcm4TlvDq8ikWAM_0JrQsNC60LjQtSDR.mp3'
  },
  { 
    id: 4, 
    speaker: 'Б', 
    text: 'Я студент факультета общественных наук.',
    audioUrl: '/audio-cache/Б_VR6AewLTigWG4xSOukaG_0K8g0LbQuNCy0YMg.mp3'
  },
  { 
    id: 5, 
    speaker: 'А', 
    text: 'Что ты изучаешь?',
    audioUrl: '/audio-cache/А_21m00Tcm4TlvDq8ikWAM_0KLRiyDRgdGC0YPQ.mp3'
  },
  { 
    id: 6, 
    speaker: 'Б', 
    text: 'Я изучаю международные отношения.',
    audioUrl: '/audio-cache/Б_VR6AewLTigWG4xSOukaG_0K8g0LfQvdCw0Y4g.mp3'
  },
  { 
    id: 7, 
    speaker: 'А', 
    text: 'Где ты живёшь?',
    audioUrl: '/audio-cache/А_21m00Tcm4TlvDq8ikWAM_0KfRgtCINGC0Ysg0.mp3'
  },
  { 
    id: 8, 
    speaker: 'Б', 
    text: 'Я живу в Любляне, в Словении.',
    audioUrl: '/audio-cache/Б_VR6AewLTigWG4xSOukaG_0K8g0LjQt9GD0YfQ.mp3'
  },
  { 
    id: 9, 
    speaker: 'А', 
    text: 'Какие языки ты знаешь?',
    audioUrl: '/audio-cache/А_21m00Tcm4TlvDq8ikWAM_0JPQtNC1INGC0Ysg.mp3'
  },
  { 
    id: 10, 
    speaker: 'Б', 
    text: 'Я знаю английский и немецкий язык.',
    audioUrl: '/audio-cache/Б_VR6AewLTigWG4xSOukaG_0K8g0YHRgtGD0LTQ.mp3'
  },
  { 
    id: 11, 
    speaker: 'А', 
    text: 'Пока!',
    audioUrl: '/audio-cache/А_21m00Tcm4TlvDq8ikWAM_0J7Rh9C10L3RjCDQ.mp3'
  },
  { 
    id: 12, 
    speaker: 'Б', 
    text: 'До свидания!',
    audioUrl: '/audio-cache/Б_VR6AewLTigWG4xSOukaG_0JTQviDRgdCy0LjQ.mp3'
  }
];

export default function ConversationRachelSamPage() {
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        >
          ...
          <p className="text-purple-200 text-lg">
            Russian Conversation - Rachel & Sam
          </p>
