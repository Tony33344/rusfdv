...
export default function ConversationSarahDanielPage() {
  return (
    <>
      <Head>
        <title>Russian Dialogue - Sarah & Daniel</title>
        <meta name="description" content="Russian Conversation with Sarah and Daniel" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-12 max-w-4xl">
          <div className="text-center mb-12">
            ...
            <p className="text-purple-200 text-lg">
              Russian Conversation - Sarah & Daniel
            </p>
